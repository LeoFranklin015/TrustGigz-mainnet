...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#FDF7F0] flex flex-col">
      {/* Navigation */}
      <nav className="border-b border-black bg-[#FDF7F0] p-4">
      ...
      {/* Hero Section */}
      <main className="flex-grow container mx-auto px-4 py-8 md:py-16 flex flex-col lg:flex-row items-center justify-center">
